...
import { TConversationCard } from "@/utils/types"
...
const generate_messages = (len: number): TMessage[] => {
    ...
    return sequence.map<TMessage>((_, idx) => ({
        ...
        createdAt: new Date(2023, random_a_number(1, 11), random_a_number(1, 31), random_a_number(0, 24), random_a_number(0, 60), random_a_number(0, 60), random_a_number(0, 1000)).toISOString()
    }))
}
