...
import { TConversationCard, TSearchConversationParams, TUserWithProfile } from '@/utils/types'
...
const ConversationCard = ({ conv }: { conv: TConversationCard }) => {
    const { avatar, lastMessageTime, pinIndex, subtitle, title } = conv
    ...
    return (
        ...
        >
            ...
            <div className="w-full max-w-[200px]">
                ...
                >
                    <p className="truncate w-full text-regular-PlaceHolderText">
                        {subtitle}
                    </p>
                    {
                        pinIndex !== 0 &&
...
const Result = ({
    ...
    return (
        ...
        >
            <Flex
                className='w-full p-3 py-2 cursor-pointer hover:bg-regular-LightGray rounded-xl'
                gap={10}
            ...
            >
                ...
                >
                    ...
                    <span className="text-xs text-regular-BlurGray">
...
const ConversationList = () => {
    ...
    return (
        conversations && conversations.length > 0 ?
            conversations.map((params) => (
                <ConversationCard conv={params} key={params.id} />
            ))
            :
            <></>
    )
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-auto relative w-full">
                ...
                <input
                    type="text"
                    className="box-border h-[40px] w-full px-10 rounded-full transition duration-200 border-2 placeholder:text-regular-PlaceHolderText outline-none text-white bg-regular-LightGray border-regular-LightGray hover:border-regular-violet hover:bg-regular-LightGray focus:border-regular-violet"
                    placeholder="Search..."
        ...
        >
            ...
            <div className="relative z-10 h-full w-full overflow-hidden">
                <div className={`${isTyping ? 'animate-super-zoom-out-fade-in' : 'animate-super-zoom-in-fade-out'} pt-3 absolute top-0 left-0 z-20 px-3 box-border w-full h-full overflow-x-hidden overflow-y-auto styled-scrollbar`}>
                    <div className="font-bold pl-3 pb-1 text-regular-BlurGray">
                        Result
                    </div>
                    <SearchResults
                        loading={searching}
