            ...
            <div className="w-full h-full cursor-default">
                {
                    recipient.Profile?.avatar ?
                        ...
                        />
                        :
                        <div className={`${robotoFont.variable} w-full h-full flex justify-center font-roboto items-center overflow-hidden text-user-avt-fsize bg-user-avt-bgimg`}>
...
const ProfileInfo = ({ recipient }: { recipient: TUserWithProfile }) => {
    ...
    return (
        <Flex
            className="px-2 pt-[0.87rem] pb-[0.87rem]"
            vertical
            gap={10}
        >
            {
                ...
                >
                    ...
                    <div className="w-info-bar-width">
                        ...
                        <p className="text-regular-text-secondary-cl mt-1">
                            Bio
                        </p>
                    </div>
                </Flex>
...
export const InfoBar = () => {
    ...
    return (
        ...
        >
            <Flex
                className="h-header-height py-[7px] px-3"
                align="center"
                gap={15}
            >
                <IconButton
